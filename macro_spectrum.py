...
s_N_m, s_I_m = spectrum.osc_spectrum(E, plot_this=True, which_isospectrum='HM', plot_un=False, matter=False)
...
aa = spectrum.osc_spectrum_no(E, which_isospectrum='DYB', bool_snf=False, bool_noneq=False, matter=False,
                              plot_this=False, plot_un=False, plot_singles=True, runtime=False)
cc = spectrum.resol_spectrum_no(E-0.78, which_isospectrum='DYB', bool_snf=False, bool_noneq=False, matter=False,
