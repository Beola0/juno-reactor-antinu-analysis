...
f = open('data/nufit_inputs.json')  # NuFIT 2019
# f = open('data/nominal_inputs.json')  # PDG 2020
...
ax = plot_function(x_=[E, E], y_=[(prob_N_me-prob_N_ve)/prob_N_me*100., (prob_I_me-prob_I_ve)/prob_I_me*100.],
                   ...
                   ylabel_=r'$(P_{\textrm{mat}} - P_{\textrm{vac}}) / P_{\textrm{mat}}$ [\%]',
...
ax = plot_function(x_=[E, E], y_=[(prob_N_me-prob_N_ve)/prob_N_me*100., (prob_I_me-prob_I_ve)/prob_I_me*100.],
                   label_=[r'NO', r'IO'], styles=['b-', 'r--'],
                   ylabel_=r'$(P_{\textrm{mat}} - P_{\textrm{vac}}) / P_{\textrm{mat}}$ [\%]',
                   xlabel_=r'$E_{\nu}$ [MeV]', xlim=[1.5, 10.5], ylim=[-0.4, 4])
ax.axvline(1.806, 0, 1, color='k', linestyle=':')
