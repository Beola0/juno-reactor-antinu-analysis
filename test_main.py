...
# sres_N, sres_I = spectrum.resol_spectrum(E-0.78, plot_this=True, matter=False)
...
plt.plot(E-0.78, nl[1], 'b--', linewidth=1, label='pull0')
...
plt.figure()
plt.plot(E-0.78, nl[0]/nl[0], 'k-', linewidth=1, label='nominal')
plt.plot(E-0.78, nl[1]/nl[0], 'b--', linewidth=1, label='pull0')
